/* 「自动翻页等待时间」取证 · 第二步：把 dump 里的 <pre id="drvReport"> 抠出来打印。
 * 运行： node verify/autonext-delay-parse.js     （需要先跑 autonext-delay-gen.js + headless Edge）
 *
...
const t = fs.readFileSync(path.join(__dirname, 'autonext-delay-dump.html'), 'utf8');
